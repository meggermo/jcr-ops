...
public final class ValidatingFunctionSupport {
    ...
    public static <S, T> Function<S, T> preAndPostValidate(Validator<S> preValidator, Function<S, T> function, Validator<T> postValidator) {
        return postValidate(preValidate(preValidator, function), postValidator);
    }
