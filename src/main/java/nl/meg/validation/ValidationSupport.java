...
public final class ValidationSupport {
     ...
     */
    public static <E, S, T> Function<S, T> preValidate(Validator<E, S> validator, Function<S, T> function) {
        return entity -> {
     ...
     */
    public static <E, S, T> Function<S, T> postValidate(Validator<E, T> validator, Function<S, T> function) {
        return entity -> {
